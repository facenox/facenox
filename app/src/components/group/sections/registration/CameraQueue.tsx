    ...
    <div className="flex h-full flex-col overflow-hidden bg-[#0f0f0f] text-white">
      ...
      <div className="scrollbar-thin scrollbar-thumb-white/10 scrollbar-track-transparent flex-1 overflow-y-auto px-6 py-6">
          ...
          <div className="space-y-6">
                ...
                <div className="flex flex-wrap gap-2">
                  <div className="relative min-w-55 flex-1">
                    ...
                    <input
                      ...
                      className="w-full rounded-xl border border-white/10 bg-white/5 py-2 pr-3 pl-10 text-[11px] font-medium text-white transition-all duration-300 outline-none placeholder:text-white/30 focus:border-cyan-500/30 focus:bg-white/10 focus:ring-4 focus:ring-cyan-500/10"
                    />
                  </div>
                  <Dropdown
                    options={[
            ...
            {memberQueue.length > 0 && (
              <button
                ...
                className="flex w-full items-center justify-center gap-2 rounded-lg border border-cyan-500/20 bg-cyan-500/10 px-4 py-3 text-[11px] font-bold tracking-wider text-cyan-400 uppercase transition-all hover:bg-cyan-500/20 active:scale-95">
        ...
        : <div className="flex h-full gap-4">
              ...
              <div className="relative flex-1 overflow-hidden rounded-lg border border-white/20 bg-black">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center bg-black/95">
                    <div className="max-w-xs space-y-4 text-center">
                      ...
                      <button
                        ...
                        className="w-full rounded-lg border border-cyan-500/20 bg-cyan-500/10 px-4 py-2.5 text-[11px] font-bold tracking-wider text-cyan-400 uppercase transition-all hover:bg-cyan-500/20 active:scale-95 disabled:cursor-not-allowed disabled:opacity-50">
                ...
                {cameraError && (
                  <div className="absolute inset-0 flex items-center justify-center bg-black/90 p-4 text-center">
                    <div className="space-y-3">
                      ...
                      <button
                        onClick={() => void startCamera()}
                        className="rounded-lg border border-white/10 bg-white/5 px-4 py-2 text-[11px] font-bold tracking-wider text-white/50 uppercase transition-all hover:text-white">
                        Try Again
                      </button>
                    </div>
                  </div>
                ...
                <div className="absolute top-2 right-2 z-10 flex items-center gap-2">
                  ...
                  <button
                    ...
                    className="rounded-lg border border-white/10 bg-white/5 px-2 py-1 text-xs font-medium text-white/30 transition-all hover:bg-white/10 hover:text-white">
                ...
                <div className="absolute inset-y-0 left-2 z-10 flex items-center">
                  <button
                    ...
                    className="rounded-full border border-white/10 bg-black/40 p-2 text-white/60 transition-all hover:bg-black/60 hover:text-white disabled:cursor-not-allowed disabled:opacity-30">
                ...
                <div className="absolute right-2 bottom-2 left-2 z-10 flex items-center gap-2">
                  ...
                  <button
                    ...
                    className={`flex-1 rounded-lg border px-4 py-2 transition-all disabled:cursor-not-allowed ${(() => {
                      ...
                      if (currentMember && !mRec?.has_consent) {
                        return "cursor-not-allowed border-white/5 bg-white/2 text-white/20"
                      }
                      return "border-cyan-500/30 bg-cyan-500/10 text-cyan-100 hover:bg-cyan-500/20 disabled:border-white/10 disabled:bg-black/40 disabled:text-white/30"
                    })()}`}>
                    {isProcessing ?
                  ...
                  {currentMember?.status === "error" && (
                    <button
                      ...
                      className="rounded-lg border border-amber-400/50 bg-amber-500/40 px-3 py-2 text-[11px] font-bold tracking-wider text-amber-100 uppercase transition-all hover:bg-amber-500/50">
                      Retry
                    </button>
                  )}
                </div>
            ...
            <div className="flex w-64 shrink-0 flex-col overflow-hidden rounded-lg border border-white/10 bg-white/5">
                    ...
                    <button
                      ...
                      <div
                        className={`flex h-5 w-5 shrink-0 items-center justify-center rounded-full text-[10px] ${
                          ...
                          : isCurrent ? "bg-white/20 text-white/60"
              ...
              {completedMembers === totalMembers && totalMembers > 0 && (
                <div className="border-t border-white/10 p-2">
                  <button
                    ...
                    className="w-full rounded-lg border border-cyan-500/30 bg-cyan-500/20 px-3 py-2 text-[11px] font-bold tracking-wider text-cyan-400 uppercase transition-all hover:bg-cyan-500/30">
